...
public class tiendaMiaHomePages {
	...
	// Localizador Comparacion de precio
	@FindBy(xpath = "/html[1]/body[1]/div[3]/div[1]/div[6]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[5]/ul[1]/li[2]/div[2]/div[2]/span[1]/span[1]/span[2]")
	private static WebElement comparacionPrecio2;
	@FindBy(xpath = "//html[1]/body[1]/div[3]/div[1]/div[6]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[5]/ul[1]/li[3]/div[2]/div[2]/span[1]/span[1]/span[2]")
	private static WebElement comparacionPrecio1;
...
/////Metodos para Ordenar productos
	...
	public void seleccionarListaDeportivo() throws InterruptedException {
	 ...
	 public static String obtenerTextoDelElemento1() {
		return comparacionPrecio1.getText();
	}

	 public static String extraerNumerosDelTexto1() {
		String texto = obtenerTextoDelElemento1();
		// Utiliza una expresión regular para extraer números
		return texto.replaceAll("[^\\d]", "");
	}

	 public static String obtenerTextoDelElemento2() {
		return comparacionPrecio2.getText();
	}

	 public static String extraerNumerosDelTexto2() {
		String texto = obtenerTextoDelElemento2();
// Utiliza una expresión regular para extraer números
		return texto.replaceAll("[^\\d]", "");
	}
	
	 public void comparacionNumeros() {
		    String texto1 = comparacionPrecio1.getText();
		    String extraerNumerosDelTexto1 = texto1.replaceAll("[^\\d]", "");

		    String texto2 = comparacionPrecio2.getText();
		    String extraerNumerosDelTexto2 = texto2.replaceAll("[^\\d]", "");

		    // Convertir las cadenas a tipos numéricos
		    int numero1 = Integer.parseInt(extraerNumerosDelTexto1);
		    int numero2 = Integer.parseInt(extraerNumerosDelTexto2);

		    // Comparar los números
		    if (numero1 < numero2) {
		        System.out.println("El precio del primer producto es menor que el precio del segundo producto.");
		    } else if (numero1 > numero2) {
		        System.out.println("El precio del primer producto es mayor que el precio del segundo producto.");
		    } else {
